...
- Platform: Vercel
- Production URL: https://app.gerendo.com
- Deploy workflow: auto-deploy on push to main
- Deploy status command: HTTP health check
- Merge method: merge
- Project type: Next.js web app
- Post-deploy health check: https://app.gerendo.com

### Custom deploy hooks
- Pre-merge: none
- Deploy trigger: automatic on push to main (Vercel GitHub integration)
- Deploy status: poll https://app.gerendo.com until 200
- Health check: https://app.gerendo.com
